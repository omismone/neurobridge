...
## Project
1. ML tool for connectivity identification available in the literature: tool [webpage](https://graph-tool.skewed.de) - reference paper (Peixoto.pdf)
...
The dimensions are 48x48, those dimensions represent brain regions (see the [supplemental material](https://static-content.springer.com/esm/art%3A10.1038%2Fs41598-023-49746-2/MediaObjects/41598_2023_49746_MOESM1_ESM.pdf) of Baruzzi's paper on the publisher's website).
...
The implementation of Peixoto's model is already done in the _graph\_tool_, use it. Start with one matrix and one patient, a following issue will be the integration of different matrices for one patient, since the tool works with only one.
...
This work replaces the second step.
